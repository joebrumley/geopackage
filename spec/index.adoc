...
[WARNING]
====
Note that the normative text for this standard is located on the OGC website: https://portal.opengeospatial.org/files/12-128r12. If there are any differences from this HTML document and the normative document, the normative document takes precedence.
====
